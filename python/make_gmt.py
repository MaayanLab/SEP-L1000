...
d_umls_perts = {}
conn = MySQLdb.connect(host='localhost',user='root', passwd='',db='drug_side_effects')
cur = conn.cursor()
...
# 	print len(val)
write_gmt(d_se_drugs, HOME+'/Documents/N2C/Sets2Networks/ET100_GOtCS_AUC_%s_proba_%s_prediction_only.gmt' %(AUC_CUTOFF, P_CUTOFF))
